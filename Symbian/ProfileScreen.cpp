...
ProfileScreen::ProfileScreen(Screen *previous, Feed *feed) : mHttp(this), previous(previous), feed(feed) {
	...
	labelContain = createLabel(blank, val);

	editBox = new EditBox(0, 6, labelContain->getWidth()-PADDING*2, val-PADDING*2, labelContain, feed->getUsername(), 0, gFontWhite, true, false, 45);
	...
	editBox = new EditBox(0, 6, labelContain->getWidth()-PADDING*2, val-PADDING*2, labelContain, feed->getEmail(), 0, gFontWhite, true, false, 45);
	editBox->setDrawBackground(false);
	labelContain->addWidgetListener(this);
	...
	editBox = new EditBox(0, 6, labelContain->getWidth()-PADDING*2, val-PADDING*2, labelContain, feed->getHandle(), 0, gFontWhite, true, false, 45);
	editBox->setDrawBackground(false);
	labelContain->addWidgetListener(this);
