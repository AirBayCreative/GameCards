...
static const char* sendToFriendlbl = "Send voucher to friend";
static const char* redeemlbl = "Redeem voucher";
...
static const char* checking_cards = "Checking for new vouchers...";
