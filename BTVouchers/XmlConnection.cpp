...
void XmlConnection::parse(MAUtil::Connection* conn, XCListener* xc, Mtx::XmlListener* xml, MAUI::Label *lbl) {
	label = lbl;
    mConn = conn;
    mXc = xc;
...
void XmlConnection::connWriteFinished(MAUtil::Connection* conn, int result) {}
