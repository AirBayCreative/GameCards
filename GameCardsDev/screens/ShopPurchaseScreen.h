...
public:
	ShopPurchaseScreen(Screen *previous, Feed *feed, Product *product, bool free = false, bool credit = false);
	~ShopPurchaseScreen();
...
private:
	...
	bool list, left, right, canPurchase, purchased, flip, freebie, credits;
