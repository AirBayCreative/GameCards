...
static String URL = "http://mobidex.mytcg.net/_phone/";
//Get user details
static String USER = URL+"?userdetails=1";
//Get user categories
static String ALBUMS = URL+"?usercategories=1";
//GET Cards in album
static String CARDS = URL+"?getcards=1";
//Trade Card in album
...
static const char* sending_card_message = "Sending album...";
static const char* card_sent_message = "Album sent successfully.";
...
static const char* xml_carddone = "cards";
//<USERDETAILS>
